...
<?php
    ...
    print "<a href='index.php'>Pagina principal</a>";
        ...
        if(empty($_SESSION['contador']) || $_SESSION['contador'] == "0"){
            ...
            print "<table style='border:2px solid black;'><th style='border:2px solid black;'>Actualizar</th><th style='border:2px solid black;'>Nombre</th><th style='border:2px solid black;'>Apellidos</th>";
               ?>
               ...
               <?php
                while($columna = mysqli_fetch_array($select)){
                    ...
                    print "<td style='border:2px solid black;'><input type='radio' name='actualizar' value=".$columna['id']."</td>";
