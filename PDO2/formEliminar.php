...
include("funciones.php");
    ...
    if(isset($_SESSION["usuario"])){
        ...
        foreach ($select as $valor) {
            ...
            <td style='border:2px solid black'><input type='checkbox' name='eliminados[]' value='$valor[dni]'></td>
        ...
        print "</table>";
        ?>
        <input type="submit" value="Borrar" name="enviar"><input type="reset" value="Cancelar" name="cancelar">
            </form>
        <?php
