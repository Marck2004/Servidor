        ...
        !is_uploaded_file($foto["tmp_name"])){
            ...
            if(in_array($foto["type"],$listaTipo)){
                ...
                try{
                    ...
                    $stmt->execute([$dni,$nombre,$apellido,$direccion,$telefono,$fichero]);

                    print "<p>La insercion resulto existosa</p>";
                    print "<p><a href='links.php'>Volver al menu</a></p>";
                    }else{
                        header("location:formInsertar.php?coincidencia=1");
                    }
                ...
                header("location:formInsertar.php?".$errorTipo);
            }
